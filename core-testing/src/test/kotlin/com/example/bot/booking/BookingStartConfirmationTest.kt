...
class BookingStartConfirmationTest :
    StringSpec({
        ...
        val pending = (result as LegacyEither.Right<LegacyConfirmResult>).value as LegacyConfirmResult.PendingPayment
        ...
        val booking = (result as LegacyEither.Right<LegacyConfirmResult>).value as LegacyConfirmResult.Confirmed
